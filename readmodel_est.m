function [m,p,mss] = readmodel_est(p_ini, pEst)
% PARAMETRIZE AND SOLVE THE MODEL

%% === Steady state parameters ===

% Potential output growth
p.ss_DLA_GDP_BAR = p_ini.ss_DLA_GDP_BAR;

% Domestic inflation target
p.ss_D4L_CPI_TAR = p_ini.ss_D4L_CPI_TAR;

% Domestic real interest rate 
p.ss_RR_BAR = p_ini.ss_RR_BAR; 

% Change in the real ER (negative number = real appreciation)
p.ss_DLA_Z_BAR = p_ini.ss_DLA_Z_BAR; 

% Foreign inflation or inflation target
p.ss_DLA_CPI_RW = p_ini.ss_DLA_CPI_RW;

% Level of foreign real interest rate
p.ss_RR_RW_BAR = p_ini.ss_RR_RW_BAR;
